...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            curIngressKeyList () {
                if (this.curIngress && this.curIngress.data.datas) {
                    const results = []
                    const keys = Object.keys(this.curIngress.data.datas)
                    keys.forEach(item => {
                        results.push({
                            key: item,
                            value: this.curIngress.data.datas[item].content
                        })
                    })
                    return results
                } else {
        ...
        methods: {
            ...
            async deleteIngresses (data) {
                ...
                this.isPageLoading = true
                try {
                    await this.$store.dispatch('resource/deleteIngresses', {
                        projectId,
                        data
                    })
                    this.$bkMessage({
