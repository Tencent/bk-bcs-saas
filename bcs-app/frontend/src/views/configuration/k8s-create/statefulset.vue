                        ...
                        <template v-if="!statefulsets.length">
                            <div class="biz-guide-box mt0">
                                <button class="bk-button bk-primary" @click.stop.prevent="addLocalApplication">
                                    ...
                                    <span style="margin-left: 0;">添加StatefulSet</span>
                                </button>
                            </div>
                        </template>
                        <template v-else>
                            <div class="biz-configuration-topbar">
                                <div class="biz-list-operation">
                                    ...
                                    <bk-tooltip ref="applicationTooltip" :content="'添加StatefulSet'" placement="top">
                            ...
                            <div class="biz-configuration-content" style="position: relative;">
                                ...
                                <div class="bk-form biz-configuration-form">
                                        ...
                                        <div class="bk-form-item">
                                            <div class="bk-form-content" style="margin-left: 0;">
                                                <div class="bk-form-inline-item is-required">
                                                    <label class="bk-label" style="width: 130px;">应用名称：</label>
                                                ...
                                                <div class="bk-form-inline-item is-required">
                                                    <label class="bk-label" style="width: 130px;">实例数量：</label>
                                                    <div class="bk-form-content" style="margin-left: 130px;">
                                                        <div class="bk-form-input-group">
                                                            <bk-input
                                                                type="number"
                                    ...
                                    <div class="bk-form-item">
                                        <label class="bk-label" style="width: 130px;">重要级别：</label>
                                    ...
                                    <div class="bk-form-item">
                                        <label class="bk-label" style="width: 130px;">描述：</label>
                                        <div class="bk-form-content" style="margin-left: 130px;">
                                    ...
                                    <div class="bk-form-item is-required">
                                        <label class="bk-label" style="width: 130px;">标签：</label>
                                        <div class="bk-form-content" style="margin-left: 130px;">
                                            <bk-keyer
                                    ...
                                    <div class="bk-form-item">
                                        <div class="bk-form-content" style="margin-left: 130px;">
                                            ...
                                            <button :class="['bk-text-button f12 mb10 pl0', { 'rotate': isPodPanelShow }]" @click.stop.prevent="togglePod">
                                                Pod模板设置<i class="bk-icon icon-angle-double-down ml5"></i>
                                            </button>
                                        </div>
                                        <bk-tab :type="'fill'" :active-name="'tab1'" :size="'small'" v-show="isMorePanelShow" style="margin-left: 130px;">
                                                ...
                                                <div class="bk-form m20">
                                                    <div class="bk-form-item">
                                                        ...
                                                        <div class="bk-form-content" style="margin-left: 155px;">
                                                            <label class="bk-form-radio">
                                                                <input type="radio" name="type" value="OnDelete" v-model="curApplication.config.spec.updateStrategy.type">
                                                                <i class="bk-radio-text">OnDelete</i>
                                                            </label>
                                                            <label class="bk-form-radio">
                                                                <input type="radio" name="type" value="RollingUpdate" v-model="curApplication.config.spec.updateStrategy.type">
                                                                <i class="bk-radio-text">RollingUpdate</i>
                                                            </label>
                                                        </div>
                                                    </div>
                                            ...
                                            <bk-tabpanel name="tab2" title="Pod管理策略">
                                                <div class="bk-form m20">
                                                    <div class="bk-form-item">
                                                        <label class="bk-label" style="width: 210px;">PodManagementPolicy：</label>
                                                        <div class="bk-form-content" style="margin-left: 210px;">
                                                            <label class="bk-form-radio">
                                                                <input type="radio" name="type1" value="OrderedReady" v-model="curApplication.config.spec.podManagementPolicy">
                                                                <i class="bk-radio-text">OrderedReady</i>
                                                            </label>
                                                            <label class="bk-form-radio">
                                                                <input type="radio" name="type1" value="Parallel" v-model="curApplication.config.spec.podManagementPolicy">
                                                                <i class="bk-radio-text">Parallel</i>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <tr v-for="(vol, index) in curApplication.config.spec.volumeClaimTemplates" :key="index">
                                                                ...
                                                                <td>
                                                                    <div class="action-box">
                                                                        <button class="action-btn ml5" @click.stop.prevent="addVolTpl()">
                                                                            <i class="bk-icon icon-plus"></i>
                                                                        </button>
                                                                        <button class="action-btn" @click.stop.prevent="removeVolTpl(vol, index)" v-show="curApplication.config.spec.volumeClaimTemplates.length > 1">
                                ...
                                <div class="bk-form biz-configuration-form pb15">
                                    ...
                                    <div class="bk-form-item is-required">
                                        <div class="bk-form-content" style="margin-left: 0">
                                            <div class="bk-form-inline-item is-required">
                                                <label class="bk-label" style="width: 130px;">容器名称：</label>
                                                <div class="bk-form-content" style="margin-left: 130px;">
                                    ...
                                    <div class="bk-form-item is-required">
                                        <label class="bk-label" style="width: 130px;">镜像及版本：</label>
                                        <div class="bk-form-content" style="margin-left: 130px;">
...
<script>
    ...
    import applicationParams from '@open/json/k8s-statefulset.json'
    ...
    export default {
        ...
        methods: {
            ...
            removeApplication (application, index) {
                ...
                this.$bkInfo({
                    title: '确认',
                    content: this.$createElement('p', { style: { 'text-align': 'center' } }, `删除StatefulSet：${application.config.metadata.name || '未命名'}`),
                    confirmFn () {
