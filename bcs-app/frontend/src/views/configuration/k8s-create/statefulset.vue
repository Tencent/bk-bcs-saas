                    ...
                    <div class="biz-tab-content" v-bkloading="{ isLoading: isTabChanging }">
                        <template v-if="!statefulsets.length">
                            <p class="biz-template-tip f12 mb10">
                                {{$t('StatefulSet是k8s中标准的有状态服务，区别于Deployment，它是一个给Pod提供唯一标志的控制器，可以保证部署和扩展的顺序')}}，<a class="bk-text-button" :href="PROJECT_CONFIG.doc.k8sStatefulset" target="_blank">{{$t('详情查看文档')}}</a>
                            </p>
                        ...
                        <template v-else>
                            ...
                            <div class="biz-configuration-topbar">
                                <div class="biz-list-operation">
                                    ...
                                    <bk-tooltip ref="applicationTooltip" :content="$t('添加StatefulSet')" placement="top">
                                ...
                                <div class="bk-form biz-configuration-form">
                                    ...
                                    <div class="bk-form-item is-required">
                                        ...
                                        <div class="bk-form-content" style="margin-left: 130px;">
                                            <bk-keyer
                                                ...
                                                :can-disabled="true">
                                                <slot>
                                                    <p class="biz-tip">{{$t('小提示：K8S使用选择器（spec.selector.matchLabels）关联资源，必填，且实例化后选择器的值不可变')}}</p>
                                                </slot>
                                            </bk-keyer>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bk-form-item">
                                        ...
                                        <bk-tab :type="'fill'" :active-name="'tab1'" :size="'small'" v-show="isMorePanelShow" style="margin-left: 130px;">
                                            ...
                                            <bk-tabpanel name="tab2" :title="$t('Pod管理策略')">
                                                <div class="bk-form m20">
                                                    <div class="bk-form-item">
                                            ...
                                            <bk-tabpanel name="ta5" :title="'HostAliases'">
                                                <div class="bk-form m20">
                                ...
                                <div class="bk-form biz-configuration-form pb15">
                                    ...
                                    <div class="bk-form-item is-required">
                                        ...
                                        <div class="bk-form-content" style="margin-left: 130px;">
                                            ...
                                            <p class="biz-tip mt10" v-if="!isLoadingImageList && !imageList.length">{{$t('提示：项目镜像不存在，')}}
                                                ...
                                                <div class="bk-form m20">
                                                    ...
                                                    <div class="bk-form-item">
                                                        ...
                                                        <div class="bk-form-content" style="margin-left: 105px;">
                                                            ...
                                                            <bk-tooltip content="设置内存limits" placement="top">
                                                                <span class="bk-badge">
                                                                    <i class="bk-icon icon-question"></i>
                                                                </span>
                                                            </bk-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            removeApplication (application, index) {
                ...
                this.$bkInfo({
                    title: this.$t('确认'),
                    content: this.$createElement('p', { style: { 'text-align': 'center' } }, `${this.$t('删除StatefulSet')}：${application.config.metadata.name || this.$t('未命名')}`),
                    confirmFn () {
