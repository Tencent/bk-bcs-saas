                        ...
                        <template v-else>
                            <div class="biz-configuration-topbar">
                                <div class="biz-list-operation">
                                    ...
                                    <bcs-popover ref="applicationTooltip" :content="$t('添加DaemonSet')" placement="top">
                            ...
                            <div class="biz-configuration-content" style="position: relative;">
                                    ...
                                    <div class="bk-form-item">
                                        ...
                                        <bk-tab :type="'fill'" :active-name="'tab2'" :size="'small'" v-show="isPodPanelShow" style="margin-left: 140px;">
                                            ...
                                            <bk-tab-panel name="tab3" :title="$t('Restart策略')">
                                                <div class="bk-form m20">
                                                    <div class="bk-form-item">
                                                        <label class="bk-label" style="width: 140px;">{{$t('重启策略')}}：</label>
                                                        <div class="bk-form-content" style="margin-left: 140px;">
                                            ...
                                            <bk-tab-panel name="tab4" :title="$t('Kill策略')">
                                                <div class="bk-form m20">
                                                    <div class="bk-form-item">
                                                        <label class="bk-label" style="width: 140px;">{{$t('宽期限')}}：</label>
                                                        <div class="bk-form-content" style="margin-left: 140px;">
                                                            <div class="bk-form-input-group">
                                                                <bkbcs-input
                                                                    type="number"
                                            ...
                                            <bk-tab-panel name="tab6" :title="$t('网络')">
                                                <div class="bk-form m20">
                                                    <div class="bk-form-item">
                                                        <label class="bk-label" style="width: 140px;">{{$t('网络策略')}}：</label>
                                                        <div class="bk-form-content" style="margin-left: 140px;">
                                                            <bk-selector
                                                                style="width: 300px;"
                                                                :placeholder="$t('请选择')"
                                                    ...
                                                    <div class="bk-form-item">
                                                        <label class="bk-label" style="width: 140px;">{{$t('DNS策略')}}：</label>
                                                        <div class="bk-form-content" style="margin-left: 140px;">
                                                            <bk-selector
                                                                style="width: 300px;"
                                                                :placeholder="$t('请选择')"
                                    ...
                                    <div style="margin-left: 140px;" v-show="isPartBShow">
                                        <bk-tab :type="'fill'" :active-name="'tab1'" :size="'small'">
                                                            ...
                                                            <table class="biz-simple-table">
                                                                ...
                                                                <tbody>
                                                                    <tr v-for="(volumeItem, index) in curContainer.volumeMounts" :key="index">
                                                                        ...
                                                                        <div class="action-box">
                                                                            <bk-button class="action-btn" @click.stop.prevent="addMountVolumn()">
                                                                                <i class="bcs-icon bcs-icon-plus"></i>
                                                                            </bk-button>
                                            ...
                                            <bk-tab-panel name="tab4" :title="$t('资源限制')">
                                                <div class="bk-form m20">
                                                    <div class="bk-form-item">
                                                        <label class="bk-label" style="width: 140px;">{{$t('特权')}}：</label>
                                                        <div class="bk-form-content" style="margin-left: 140px;">
                                                    ...
                                                    <div class="bk-form-item">
                                                        <label class="bk-label" style="width: 140px;">{{$t('内存')}}：</label>
                                                        <div class="bk-form-content" style="margin-left: 140px;">
                                                            <div class="bk-form-input-group mr5">
                                                                <span class="input-group-addon is-left">
                                                                    requests
                                ...
                                <div class="operation-area mt30 mb50" style="margin-left: 140px;">
                                </div>
                            </div>
                        </template>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            removeApplication (application, index) {
                ...
                this.$bkInfo({
                    title: this.$t('确认删除'),
                    content: this.$createElement('p', { style: { 'text-align': 'left' } }, `${this.$t('删除DaemonSet')}：${application.config.metadata.name || this.$t('未命名')}`),
                    confirmFn () {
