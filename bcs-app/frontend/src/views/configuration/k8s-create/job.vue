                        ...
                        <template v-else>
                            <div class="biz-configuration-topbar">
                                <div class="biz-list-operation">
                                    ...
                                    <bcs-popover ref="applicationTooltip" :content="$t('添加Job')" placement="top">
                                ...
                                <div class="bk-form biz-configuration-form">
                                    ...
                                    <div class="bk-form-item">
                                        ...
                                        <bk-tab :type="'fill'" :active-name="'tab1'" :size="'small'" v-show="isMorePanelShow" style="margin-left: 140px;">
                                            <bk-tab-panel name="tab1" :title="$t('Pod运行设置')">
    ...
    export default {
        ...
        methods: {
            ...
            removeApplication (application, index) {
                ...
                this.$bkInfo({
                    title: this.$t('确认删除'),
                    content: this.$createElement('p', { style: { 'text-align': 'left' } }, `${this.$t('删除Job')}：${application.config.metadata.name || this.$t('未命名')}`),
                    confirmFn () {
