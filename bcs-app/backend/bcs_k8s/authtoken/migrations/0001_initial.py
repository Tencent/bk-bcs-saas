...
import backend.bcs_k8s.authtoken.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(db_index=True, default=backend.bcs_k8s.authtoken.models.make_random_key, max_length=64, unique=True, verbose_name='Key')),
