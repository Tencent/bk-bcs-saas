...
def common_patch():
    with mock.patch('backend.dashboard.workload.views.stateful_set.SystemViewSet', new=FakeSystemViewSet), \
...
class TestStatefulSet:
    ...
    def test_list(self, api_client, project_id, cluster_id):
        ...
        response = api_client.get(
            f'/api/dashboard/projects/{project_id}/clusters/{cluster_id}/workload/stateful_set/'
        )
