...
def common_patch():
    with mock.patch('backend.dashboard.workload.views.pod.SystemViewSet', new=FakeSystemViewSet), \
...
class TestPod:
    ...
    def test_list(self, api_client, project_id, cluster_id):
        ...
        response = api_client.get(
            f'/api/dashboard/projects/{project_id}/clusters/{cluster_id}/workloads/pods/'
        )
