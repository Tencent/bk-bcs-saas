...
#
# Generated by Django 1.11.5 on 2018-03-29 07:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('variable', '0002_auto_20180328_1815'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster_id', models.CharField(max_length=64, verbose_name='集群ID')),
        ...
        migrations.AlterUniqueTogether(
            name='clustervariable',
            unique_together=set([('var_id', 'cluster_id')]),
        ),
    ]
