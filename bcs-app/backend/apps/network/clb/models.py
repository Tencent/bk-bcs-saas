...
class Manager(models.Manager):
    ...
    def create(self, data):
        data["config"] = json.dumps({
            ...
            "is_customized_image_url": data.pop("is_customized_image_url", False),
            "clb_controller_image_url": data.pop("clb_controller_image_url", ""),
            "clb_nginx_image_url": data.pop("clb_nginx_image_url", "")
        })
