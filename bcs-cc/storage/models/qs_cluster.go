...
// SetExtraClusterID is an autogenerated method
// nolint: dupl
func (u ClusterUpdater) SetExtraClusterID(extraClusterID string) ClusterUpdater {
...
var ClusterDBSchema = struct {
	...
	ExtraClusterID    ClusterDBSchemaField
}{
	...
	ExtraClusterID:    ClusterDBSchemaField("extra_cluster_id"),
}
...
func (o *Cluster) Update(db *gorm.DB, fields ...ClusterDBSchemaField) error {
	dbNameToFieldName := map[string]interface{}{
		...
		"extra_cluster_id":    o.ExtraClusterID,
	}
